...
# location rather than one machine's absolute paths.
_REPO_ROOT = Path(__file__).resolve().parent.parent
FONTS_DIR = str(_REPO_ROOT / "backend" / "app" / "static" / "fonts")
OUT_CSS = str(_REPO_ROOT / "backend" / "app" / "static" / "css" / "fonts.css")
